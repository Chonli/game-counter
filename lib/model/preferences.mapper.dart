...
class PreferencesMapper extends ClassMapperBase<Preferences> {
  ...
  static const Field<Preferences, ThemeMode> _f$themeMode = Field(
    'themeMode',
    _$themeMode,
    opt: true,
  ...
  static const Field<Preferences, String> _f$language = Field(
    'language',
    _$language,
    opt: true,
    def: 'en',
...
mixin PreferencesMappable {
  String toJson() {
    return PreferencesMapper.ensureInitialized().encodeJson<Preferences>(
      this as Preferences,
    );
  }

  Map<String, dynamic> toMap() {
    return PreferencesMapper.ensureInitialized().encodeMap<Preferences>(
      this as Preferences,
    );
  }
  ...
  @override
  String toString() {
    return PreferencesMapper.ensureInitialized().stringifyValue(
      this as Preferences,
    );
  }
  ...
  bool operator ==(Object other) {
    return PreferencesMapper.ensureInitialized().equalsValue(
      this as Preferences,
      other,
    );
  }
...
class _PreferencesCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({ThemeMode? themeMode, String? language}) => $apply(
    FieldCopyWithData({
