...
class GameOptionsMapper extends ClassMapperBase<GameOptions> {
  ...
  static const Field<GameOptions, int> _f$maxScoreByRound = Field(
    'maxScoreByRound',
    _$maxScoreByRound,
    opt: true,
  );
  static int? _$maxScore(GameOptions v) => v.maxScore;
  static const Field<GameOptions, int> _f$maxScore = Field(
    'maxScore',
    _$maxScore,
    opt: true,
  );
  static int? _$maxRounds(GameOptions v) => v.maxRounds;
  static const Field<GameOptions, int> _f$maxRounds = Field(
    'maxRounds',
    _$maxRounds,
    opt: true,
  );
...
mixin GameOptionsMappable {
  String toJson() {
    return GameOptionsMapper.ensureInitialized().encodeJson<GameOptions>(
      this as GameOptions,
    );
  }

  Map<String, dynamic> toMap() {
    return GameOptionsMapper.ensureInitialized().encodeMap<GameOptions>(
      this as GameOptions,
    );
  }
  ...
  @override
  String toString() {
    return GameOptionsMapper.ensureInitialized().stringifyValue(
      this as GameOptions,
    );
  }
  ...
  bool operator ==(Object other) {
    return GameOptionsMapper.ensureInitialized().equalsValue(
      this as GameOptions,
      other,
    );
  }
